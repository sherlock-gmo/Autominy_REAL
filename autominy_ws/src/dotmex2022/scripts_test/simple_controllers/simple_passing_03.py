...
#----------------------------------------------------------------------------------------------------------------
	def __init__(self):
		...
		self.Ev = False
		#V. Camera
		self.l = 30 #60 # Tamano de la recta con que se modela el camino
		self.FT = 0
		self.side = 1 #-1 # 1=Derecha -1=Izquierda
		self.x_ref = 120 #120# 88
		self.x1_h = 105
		self.x_search = 160 #60
		self.v = 0
...
if __name__ == '__main__':
	print("Nodo inicializado: simple_passing_03.py")
	rospy.init_node('simple_passing_03',anonymous=True)
	autominy()
	rospy.spin()

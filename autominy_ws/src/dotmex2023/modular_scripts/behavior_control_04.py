...
#																	LIDAR
	def callback_Lidar(self, data_lidar):
		...
		cam_post = [157,158,159,160,161,200,201,202,203,204]
...
#																	YOLO
	def callback_Yolo(self,data_yolo):
		...
		for i in range(len(id_class)):
			...
			if (id_number == 0) and (area>=9000) and (220<=cx<=425) and (p>=0.85): self.v_max = 0			# Carro
			#print('cy ',cy)
			#print('cx ',cx) #and (area>=4313) and (250<=cx<=380): self.Car = True										# Coche			
			#print('area ',area)

...
"""autogenerated by genpy from autominy_msgs/Trajectory.msg. Do not edit."""
import codecs
import sys
...
class Trajectory(genpy.Message):
  ...
  _type = "autominy_msgs/Trajectory"
  _has_header = True  # flag to mark the presence of a Header object
  _full_text = """# This represents an trajectory.
...
float64 z"""
  ...
  _slot_types = ['std_msgs/Header','string','autominy_msgs/TrajectoryPoint[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = autominy_msgs.msg.TrajectoryPoint()
        _v11 = val1.pose
        _v12 = _v11.position
        _x = _v12
        start = end

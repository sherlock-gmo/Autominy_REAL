...
(cl:defclass <Obstacles> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (obstacles
    :reader obstacles
    :initarg :obstacles
    :type (cl:vector autominy_msgs-msg:Obstacle)
   :initform (cl:make-array 0 :element-type 'autominy_msgs-msg:Obstacle :initial-element (cl:make-instance 'autominy_msgs-msg:Obstacle))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Obstacles>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Obstacles)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autominy_msgs-msg:<Obstacles> is deprecated: use autominy_msgs-msg:Obstacles instead.")))
...
(cl:defmethod obstacles-val ((m <Obstacles>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autominy_msgs-msg:obstacles-val is deprecated.  Use autominy_msgs-msg:obstacles instead.")
  (obstacles m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Obstacles>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'obstacles)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'autominy_msgs-msg:Obstacle))

...
class SteeringPWMCommand {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new SteeringPWMCommand(null);
  ...
  static datatype() {
    ...
    return 'autominy_msgs/SteeringPWMCommand';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SteeringPWMCommand(null);
...
module.exports = SteeringPWMCommand;

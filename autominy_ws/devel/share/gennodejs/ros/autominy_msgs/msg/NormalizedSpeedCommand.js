...
class NormalizedSpeedCommand {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new NormalizedSpeedCommand(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new NormalizedSpeedCommand(null);
...
module.exports = NormalizedSpeedCommand;
